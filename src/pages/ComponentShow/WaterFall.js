...
// 引入瀑布流插件
import WaterFallCom from "../../components/waterFallCom";
...
class WaterFall extends Component {
  ...
  componentDidMount() {
    ...
    this.state.dataSource.map((e, index) => {
      ...
      dd["img"] = e;
      dd["shunxu"] = index + 1;
      this.state.listSource.push(dd);
    });

    console.log("kanyixia ", this.state.listSource);
  }
  ...
  render() {
    ...
    return (
      <Layout className="full-layout gallery-page">
        <Content>
          <WaterFallCom datasource={dataSource} />
